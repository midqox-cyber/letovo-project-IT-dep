...
- Создатель становится **главным группы**: он может добавлять участников в уже работающую
  комнату, удалять их и включать или снимать `mute`. Пользователь с `mute` видит историю,
  но не может отправлять сообщения. Администратор имеет те же права модерации.
